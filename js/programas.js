...
document.addEventListener('DOMContentLoaded', function() {
            ...
            .then(data => {
                ...
                Object.keys(facultadesData).forEach(facultadId => {
                    ...
                    facultad.programas.forEach(programa => {
                        ...
                        let duracion = '';
                        if (programa.tipo === 'maestria' && facultad.duracion?.maestria) {
                            duracion = facultad.duracion.maestria;
                        } else if (programa.tipo === 'doctorado' && facultad.duracion?.doctorado) {
                            duracion = facultad.duracion.doctorado;
                        } else if (facultad.duracion) {
                            duracion = facultad.duracion.maestria || facultad.duracion.doctorado || '';
                        }
                        programas.push({
                            ...programa,
                            facultad: facultadId,
    ...
    function crearProgramaCard(programa, index) {
        let tipoBadgeClass, tipoTexto;
        if (programa.tipo === 'maestria') {
            tipoBadgeClass = 'tipo-maestria';
            tipoTexto = 'Maestría';
        } else if (programa.tipo === 'doctorado') {
            tipoBadgeClass = 'tipo-doctorado';
            tipoTexto = 'Doctorado';
        } else if (programa.tipo === 'especialidad') {
            tipoBadgeClass = 'tipo-especialidad';
            tipoTexto = 'Especialidad';
        } else {
            tipoBadgeClass = 'tipo-otro';
            tipoTexto = programa.tipo || 'Programa';
        }
